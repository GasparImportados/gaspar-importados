...
const products = [
  { name: "Asad Lattafa 100ml", price: "R$ 219,99", category: "Perfumes Árabes", tag: "Fragrância intensa e marcante", img: "assets/asad-lattafa.png.png" },
  ...
  { name: "Yara Candy 100ml", price: "R$ 199,99", category: "Perfumes Árabes", tag: "Doce, jovem e envolvente", img: "assets/yara-candy.png.png" },
  { name: "Durrat Al Aroos EDP 85ml", price: "R$ 199,99", category: "Perfumes Árabes", tag: "Delicado e sofisticado", img: "assets/durrat-al-aroos.png.png" },
  { name: "Eclaire EDP 100ml", price: "R$ 215,99", category: "Perfumes Árabes", tag: "Doçura cremosa e elegante", img: "assets/eclaire.png.png" },
  { name: "Khamrah Lattafa EDP", price: "R$ 249,99", category: "Perfumes Árabes", tag: "Quente, envolvente e marcante", img: "assets/khamrah.png.png" },
  { name: "Yara Moi Branco EDP 100ml", price: "R$ 199,99", category: "Perfumes Árabes", tag: "Feminino e elegante", img: "assets/yara-moi-branco.png.png" },
  { name: "Yara Tous Amarelo EDP 100ml", price: "R$ 199,99", category: "Perfumes Árabes", tag: "Vibrante e sofisticado", img: "assets/yara-tous-amarelo.png.png" },
  { name: "Pride Of Lattafa Fakhar Black", price: "R$ 199,99", category: "Perfumes Árabes", tag: "Assinatura masculina marcante", img: "assets/fakhar-black.png.png" },
  { name: "Rasasi Hawas For Him", price: "R$ 214,99", category: "Perfumes Árabes", tag: "Fresco, intenso e desejado", img: "assets/rasasi-hawas.png.png" },
  { name: "Sabah Al Ward EDP 100ml", price: "R$ 169,99", category: "Perfumes Árabes", tag: "Floral, elegante e feminino", img: "assets/sabah-al-ward.png.png" },
  { name: "The Kingdom 100ml", price: "R$ 299,99", category: "Perfumes Árabes", tag: "Presença real e sofisticada", img: "assets/the-kingdom.png.png" },
  { name: "212 VIP 80ml", price: "R$ 799,99", category: "Perfumes Importados", tag: "Estilo urbano e exclusivo", img: "assets/212-vip.png.png" },
  { name: "Armani Acqua di Gio Parfum 100ml", price: "R$ 749,99", category: "Perfumes Importados", tag: "Elegância aquática masculina", img: "assets/armani-acqua-di-gio.png.png" },
  { name: "Azzaro Wanted EDP 100ml", price: "R$ 599,99", category: "Perfumes Importados", tag: "Intenso e sedutor", img: "assets/azzaro-wanted.png.png" },
  { name: "Dolce & Gabbana The King Fem EDP 100ml", price: "R$ 599,99", category: "Perfumes Importados", tag: "Elegância feminina", img: "assets/the-king-fem.png.png" },
  { name: "Dolce & Gabbana The One Gold 100ml", price: "R$ 699,99", category: "Perfumes Importados", tag: "Luxo em forma de fragrância", img: "assets/the-one-gold.png.png" },
  { name: "Dolce & Gabbana The King EDP 100ml", price: "R$ 649,99", category: "Perfumes Importados", tag: "Presença masculina sofisticada", img: "assets/the-king-edp.png.png" },
  { name: "Gabrielle Chanel EDP 100ml", price: "R$ 1.299,99", category: "Perfumes Importados", tag: "Clássico feminino de alto padrão", img: "assets/gabrielle-chanel.png.png" },
  { name: "Hidratante Angel 200ml", price: "R$ 499,99", category: "Perfumes Importados", tag: "Cuidado sofisticado", img: "assets/hidratante-angel.png.png" },
